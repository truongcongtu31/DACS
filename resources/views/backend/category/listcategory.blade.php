...
@section('search')
    <li class="nav-item">
        <form class="search-form" method="GET" action="{{ route('searchcategory') }}">
                ...
                <div class="col-sm-12">
                    <div class="home-tab">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h2 style="text-align: center">List Category Product</h2>
                                    <p class="card-description right">
                                        <a href="{{ route('addcategory') }}"><button class="btn btn-primary"
                                                style="color: aliceblue">Add new category</button></a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="12">Không có danh mục sản phẩm</td>
                                                    </tr>
